...
import type {NavigationLink} from '@/types/site-config'
...
export const rootNotionSpaceId: string | null = parsePageId(
  getSiteConfig('rootNotionSpaceId', undefined),
  {uuid: true}
)
...
function invertPageUrlOverrides(
  _pageUrlOverrides: PageUrlOverridesMap
): PageUrlOverridesInverseMap {
  return Object.keys(_pageUrlOverrides).reduce((acc, uri) => {
    const pageId = _pageUrlOverrides[uri]!
